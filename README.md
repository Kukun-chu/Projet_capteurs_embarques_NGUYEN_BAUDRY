...
**Se placer au bon endroit pour deploy**
```
cd Projet_capteurs_embarques_NGUYEN_BAUDRY/mbed-os-example-blinky/mbed-os
```
...
```
git checkout exos (il faut se trouver à Projet_capteurs_embarques_NGUYEN_BAUDRY)
```
